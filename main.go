...
func main() {
	...
	apiURL := flag.String("url", "http://localhost:8000/v1/completions", "API endpoint URL")
	model := flag.String("model", "/home/models/DeepSeek-R1-Distill-Qwen-32B", "Model name/path")
